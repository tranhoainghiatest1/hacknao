...
from seed_units_41_to_50 import UNITS_41_TO_50

ALL_UNITS = UNITS_1_TO_10 + UNITS_11_TO_20 + UNITS_21_TO_30 + UNITS_31_TO_40 + UNITS_41_TO_50
...
def generate_vocab_dataset():
    ...
    print(f"🎉 Đã xuất thành công {len(all_vocab)} từ vựng chuẩn Unit 1 đến Unit 50 (TOÀN BỘ 50 UNITS CUỐN SÁCH) vào: {output_path}")
